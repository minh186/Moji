...
const ChatWindowBody = () => {
  ...
  // lấy những tin nhắn thuộc cuộc hội thoại đang active và tìm cuộc hội thoại đang mở
  ...
  // lưu vị trí cuộn hiện tại vào session storage
  ...
  // cuộn đến vị trí đã lưu trong session storage khi component render
  useLayoutEffect(() => {
    const container = containerRef.current;
    if (!container) return;
